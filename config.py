...
# --- Robot IPs (override in .env for lab) ---
...
# --- Connection timeout (seconds) — prevents script from hanging ---
...
PEPPER_LISTEN_TIMEOUT = int(os.environ.get("PEPPER_LISTEN_TIMEOUT", "10"))
